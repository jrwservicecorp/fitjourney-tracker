...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Nutrition Log Form Submission – default date if missing and include meal category.
  document.getElementById("nutrition-log-form").addEventListener("submit", function(e) {
    ...
    // Get conversion factor from the selected unit option; default is 1.
    let conversion = parseFloat($("#food-uom option:selected").attr("data-conversion")) || 1;
    // Compute the weight in grams based on quantity and conversion.
  ...
  // Update unit display on change and recalc nutrients.
