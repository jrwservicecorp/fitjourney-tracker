// FitJourney Tracker - Version v7.63 (Fixing ChartModule & Weight Logging)

console.log("FitJourney Tracker v7.63 initializing...");
...
window.onload = function() {
    try {
        ...
        if (requiredElements.versionDisplay) {
            requiredElements.versionDisplay.innerText = "v7.63";
        }
        ...
        console.log("All modules initialized successfully in FitJourney Tracker v7.63.");
    } catch (error) {
