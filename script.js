/* script.js - FitJourney Tracker - Modern Edition - JS v3.6.2 */
...
if (typeof Konva === "undefined") {
  console.error("Konva is not defined. Please ensure Konva is loaded via CDN (e.g., https://unpkg.com/konva@8.3.5/konva.min.js).");
}
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function openComparisonEditor() {
    ...
    const beforePhoto = photoLogs[beforeIndex];
    const afterPhoto = photoLogs[afterIndex];
    $("#comparison-editor-modal").style.display = "block";
